...
def extract_weather_data(**context):
    ...
    response = http_hook.run(
        endpoint='/data/2.5/weather?q=Portland&APPID='6233159967eb45f342f3c82ab2c9d6ac
...
def transform_load_data(task_instance):
    ...
    aws_credentials = {
        "key": "nsJYW0R7UNRjK4Hwk8xIS1bQBuUjadmzEzTZNef ",
        "secret": "nsJYW0R7UNRjK4Hwk8xIS1bQBuUjadmzEzTZNef",
        "token": "Updb3JpzZ1McXyjEub"
    }
